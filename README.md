...
Current status: **M1 — Rendering Foundation complete**. A Windows-first diagnostic client opens a real `wgpu`/D3D12 surface and renders a code-generated 3D cube; it is an engineering proof, not a playable game.
