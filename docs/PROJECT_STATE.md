...
**M5 — Procedural Character is the next milestone.** Nothing of it exists yet. Documentation-only preparation lives on `feat/m5-procedural-character`; see [`agents/HANDOFF.md`](agents/HANDOFF.md) for the accepted scope and for what is deliberately still undecided.
