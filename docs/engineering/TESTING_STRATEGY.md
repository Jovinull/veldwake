...
- **Hydrology**: the water surface never rises downstream; the channel bed stays below it along the whole axis; the meadow never floods; the waterline does not step across a seam; water never stands above the ground it touches.
