...
use crate::spec::{
    ArenaSpec, AuthoredAdversary, AuthoredAttack, AuthoredDodge, AuthoredMovement, AuthoredTuning,
    CombatSeed,
};
...
#[must_use]
pub fn locked_values() -> [(&'static str, u64); 6] {
    [
...
pub fn measured_values() -> Result<[(&'static str, u64); 6], EncounterError> {
