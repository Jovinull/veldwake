...
use crate::combatant::{Action, AttackKind, SIDES, SwingId};
...
pub fn attack_envelope(
    ...
    for elapsed in 0..=spec.total() {
        // A weapon's envelope is its primary swing: the player never swings
        // anything else, and the found weapon is armament, not an attack kind.
